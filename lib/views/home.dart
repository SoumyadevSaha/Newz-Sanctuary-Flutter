        ...
        title: GestureDetector(
          ...
          child: Row(
            ...
            children: const <Widget>[
              Text("Newz"),
              Text(" Sactuary", style: TextStyle(color: Colors.blue)),
            ],
          ),
        ),
        elevation: 0.0,
        ...
        child: Stack(
          children: <Widget>[
            ClipRRect(
              ...
              child: CachedNetworkImage(width: 150, height: 90, fit: BoxFit.cover, imageUrl: imageUrl,),
            ),
            Container(
              ...
              child: Text(categoryName, style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
            )
          ],
        ),
      ),
